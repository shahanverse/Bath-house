...
const mostLovedItems = [
  { img: ct1, title: '4 WAY HOOK THE BATH HOUSE', price: 'Rs. 2,565.00', cut: ' Rs. 2,850.00'},
  { img: ct2, title: 'THUMBLER HOLDER - THE BATH HOUSE', price: 'Rs. 2,565.00', cut: ' Rs. 2,100.00'},
  { img: ct3, title: 'TOWEL BAR - THE BATH HOUSE', price: 'Rs. 2,565.00', cut: ' Rs. 2,450.00'},
  { img: ct4, title: 'SOAP DISH - THE BATH HOUSE', price: 'Rs. 2,565.00', cut: ' Rs. 2,100.00'},
...
function Towel() {
  return (
    <section className="max-w-8xl mx-auto px-4 py-16">
      <h1 className="text-center text-5xl font-extrabold tracking-tight font-sans">TOWEL & PAPER HOLDERS</h1>
